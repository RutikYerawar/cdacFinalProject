...
const Changestatus = () => {
  ...
  function savePizza() {
    if (deliverystatus === "") alert("Enter  type of pizza");
    else {
      const body = {
        deliverystatus,
      };
      ...
      // http://localhost:7071/DeliveryStatus/dStatus/1
      // http://localhost:7071/DeliveryStatus/dStatus/1
            ...
            <div className="row">
              <div className="col">
                <p>
                  ...
                  <p>
                    <b>Pizza Name :</b>
                    {product.itemsize.item.itemName}
                  </p>
                  <p>
                    <b>Pizza Size :</b> {product.itemsize.size}
                  </p>
                  <p>
                    <b>Current Delivery Status :</b>{" "}
                    {product.deliveryId.deliveryStatus}
                  </p>
