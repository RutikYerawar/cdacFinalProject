...
const Addpizza = () => {
  ...
  function savePizza() {
    if (type === "") alert("Enter  type of pizza");
    else if (itemName === "") alert("Enter the pizza name");
    else if (description === "") alert("Enter pizza description");
    else {
      const body = {
        type,
        itemName,
    ...
    <>
      ...
      <div className="outerdiv-emp-form">
        <div className="mb-3">
          ...
          >
            <option value={settype}>Select Type</option>
